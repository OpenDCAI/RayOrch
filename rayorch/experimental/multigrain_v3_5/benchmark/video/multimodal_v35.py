"""Whisper-audio plus ViT-frame dual relation on Multigrain v3.5."""
...
class VideoMultimodalV35Pipeline(Pipeline):
...
def run_multimodal_v35(
    ...
    **pipeline_options: Any,
    ...
    """Run the dual-relation v3.5 multimodal pipeline."""

    with Executor(VideoMultimodalV35Pipeline(**pipeline_options)) as executor:
        return executor.run(
            paths,
...
__all__ = ["VideoMultimodalV35Pipeline", "run_multimodal_v35"]
