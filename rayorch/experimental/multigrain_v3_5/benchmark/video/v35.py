"""Video→Frame→Feature→Video on Multigrain v3.5.
...
class VideoV35Pipeline(Pipeline):
...
def run_v35(
    ...
    **pipeline_options: Any,
    ...
    """Run the v3.5 feature pipeline on an initialized or local Ray runtime."""

    with Executor(VideoV35Pipeline(**pipeline_options)) as executor:
        return executor.run(
            paths,
...
__all__ = ["VideoV35Pipeline", "run_v35"]
