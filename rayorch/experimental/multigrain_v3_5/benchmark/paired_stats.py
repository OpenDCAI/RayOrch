...
def paired_timing_summary(
    ...
    return {
        ...
        "v35_wall_s": sample_summary(new),
        "paired_v35_minus_v3_s": sample_summary(deltas),
        "paired_v35_relative_change": sample_summary(relative),
        "paired_v35_speedup": sample_summary(speedups),
        "v35_faster_trials": sum(delta < 0 for delta in deltas),
