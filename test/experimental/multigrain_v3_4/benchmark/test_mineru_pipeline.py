"""MinerU v3.4 Pipeline 的静态结构、业务 UDF 复用与 CLI gate 测试。"""
...
from rayorch.experimental.multigrain_v3_4.benchmark.mineru import (
    MinerUV33Pipeline,
    build_parser,
)
...
def _pipeline(mode: str = "elastic") -> MinerUV33Pipeline:
    ...
    return MinerUV33Pipeline(
        output_dir="/tmp/v34-mineru-test",
        mode=mode,
        model="model",
        replicas=4,
        batch_size=64,
...
def test_mineru_v34_has_four_calls_and_zero_structural_pools():
